    ...
    <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div className="flex lg:flex-1">
        <a href="#" className="-m-1.5 p-1.5">
          <span className="text-xl font-bold text-gray-900">AI Daily News</span>
        </a>
      </div>
      <div className="flex flex-1 justify-end">
        <a href="#pricing" className="text-sm font-semibold leading-6 text-gray-900">
          <span className="rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500">
            7日間 無料で試す
          </span>
        </a>
      </div>
  ...
  <div className="bg-white py-24 sm:py-32" id="features">
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl lg:text-center">
        <h2 className="text-base font-semibold leading-7 text-blue-600">時間を価値に変える</h2>
        <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">AI時代の、新しいニュース体験</p>
        <p className="mt-6 text-lg leading-8 text-gray-600">単なる情報収集では終わらない。あなたの意思決定を加速させる、唯一無二のインテリジェンス・レポートです。</p>
      </div>
      <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
        <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
          <div className="flex flex-col"><dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900"><div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-600 text-white"><ClockIcon /></div>圧倒的な「時間対効果」</dt><dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600"><p className="flex-auto">冒頭の「60秒要点キャッチアップ」で、世界の最先端を即座に把握。多忙な日でも、これさえ読めば時流から取り残されません。</p></dd></div>
          <div className="flex flex-col"><dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900"><div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-600 text-white"><ChartIcon /></div>単なる要約ではない「独自分析レポート」</dt><dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600"><p className="flex-auto">ニュースの裏側にある「深掘りすべき論点」と、明日から使える「実践的アクションプラン」を提示。日々の業務にすぐに活かせます。</p></dd></div>
  ...
  <div className="bg-slate-50 py-24 sm:py-32" id="pricing">
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">あなたに合ったプランを選べます</p>
        <p className="mt-6 text-lg leading-8 text-gray-600">まずは7日間の無料トライアルで、全ての機能をお試しください。</p>
      </div>
      {/* ▼▼▼ 修正点: gap-y-10 と lg:gap-x-8 で距離を調整 ▼▼▼ */}
      <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-10 sm:mt-20 lg:max-w-4xl lg:grid-cols-2 lg:gap-x-8">
        <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-200 sm:p-10 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl">
          <h3 className="text-base font-semibold leading-7 text-blue-600">月額プラン</h3>
          <div className="mt-4 flex items-baseline gap-x-2"><span className="text-5xl font-bold tracking-tight text-gray-900">300</span><span className="text-base font-semibold leading-7 text-gray-600">円/月</span></div>
          <p className="mt-6 text-base leading-7 text-gray-600">まずは気軽に始めたい方向けのプランです。</p>
          <p className="mt-1 text-sm text-gray-500">1日あたり約10円</p>
          <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-gray-600"><li className="flex gap-x-3"><CheckIcon />毎日のニュースレター配信</li><li className="flex gap-x-3"><CheckIcon />いつでも解約可能</li></ul>
          <a href="#" className="mt-10 block w-full rounded-md bg-blue-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500">無料トライアルを始める</a>
        </div>
        <div className="relative rounded-2xl bg-white p-8 shadow-xl ring-1 ring-gray-900/10 sm:p-10 transition-all duration-300 ease-in-out hover:scale-105">
          <div className="absolute top-4 right-4 z-10"><span className="inline-flex items-center rounded-full bg-blue-100 px-3 py-1 text-base font-semibold text-blue-700">約17% お得</span></div>
          <h3 className="text-base font-semibold leading-7 text-blue-600">年間プラン</h3>
          <div className="mt-4 flex items-baseline gap-x-2"><span className="text-5xl font-bold tracking-tight text-gray-900">3,000</span><span className="text-base font-semibold leading-7 text-gray-600">円/年</span></div>
          <p className="mt-6 text-base leading-7 text-gray-600">お得に長期間利用したい方向けのプランです。</p>
          <p className="mt-1 text-sm text-gray-500">月々支払うより600円お得です</p>
          <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-gray-600"><li className="flex gap-x-3"><CheckIcon />毎日のニュースレター配信</li><li className="flex gap-x-3"><CheckIcon />いつでも解約可能</li></ul>
          <a href="#" className="mt-10 block w-full rounded-md bg-blue-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500">無料トライアルを始める</a>
        </div>
      </div>
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-4xl py-16 px-6 sm:py-24 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
          <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">今すぐ、未来の情報を手に入れる。</h2>
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
            AIの進化に取り残される不安を、最先端を走る自信へ。最初の7日間は無料です。
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a href="#pricing" className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100">
              7日間の無料トライアルを始める
            </a>
          </div>
          <svg viewBox="0 0 1024 1024" className="absolute left-1/2 top-1/2 -z-10 h-[64rem] w-[64rem] -translate-x-1/2 [mask-image:radial-gradient(closest-side,white,transparent)]" aria-hidden="true">
            <circle cx={512} cy={512} r={512} fill="url(#8d958450-c69f-4251-94bc-4e091a323369)" fillOpacity="0.7" />
            <defs><radialGradient id="8d958450-c69f-4251-94bc-4e091a323369"><stop stopColor="#7775D6" /><stop offset={1} stopColor="#E935C1" /></radialGradient></defs>
          </svg>
        </div>
      </div>
    </div>
